...
/*
 * This class is the central storage of all settings that the 
 * StepCounterActivity has to keep track of. This means that the 
 * various Services and Activities can be killed and restarted, but 
 * this will always keep track of what the user selected, and will 
 * keep the logging file open, etc.
 * 
 * XXX: Eventually this could/should become a real (non-static) MVC 
 * class with real listeners...
 *  
 * @author Bart Coppens
 * @author Andy Georges
